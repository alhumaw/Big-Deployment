...
sudo sed -i "s/10.152.183.93:8000/$NEW_IP:8000/g" /etc/nginx/conf.d/proxy.conf
...
sudo echo "load_module /etc/nginx/modules/ngx_http_modsecurity_module.so;" >> /etc/nginx/nginx.conf
